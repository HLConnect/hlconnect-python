...
class ViewUrl(BaseModel):
    ...
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="Secure, time-limited URL that can be used to view the purchased digital asset online. The URL expires after a predetermined period.")
