...
class ErrorResponse(BaseModel):
    ...
    code: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Error code")
    status: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Response status")
    __properties: ClassVar[List[str]] = ["name", "message", "code", "status"]
