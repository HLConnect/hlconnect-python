...
class RenderingItem(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Rendering type (pdf, scorch, musicxml, embed, audio, streaming).")
    usage: Optional[StrictStr] = Field(default=None, description="Rendering usage (full or preview).")
