...
class TestRenderingItem(unittest.TestCase):
    """RenderingItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RenderingItem:
        """Test RenderingItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RenderingItem`
        """
        model = RenderingItem()
        if include_optional:
