...
from hlconnect_client.configuration import Configuration
from hlconnect_client.api_response import ApiResponse, T as ApiResponseT
import hlconnect_client.models
from hlconnect_client import rest
from hlconnect_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(hlconnect_client.models, klass)
