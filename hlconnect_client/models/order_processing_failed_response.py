...
class OrderProcessingFailedResponse(BaseModel):
    """
    OrderProcessingFailedResponse
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Failed order status")
    message: Optional[StrictStr] = Field(default=None, description="Detailed error message explaining the failure")
