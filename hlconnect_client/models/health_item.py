...
class HealthItem(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the system component being checked (e.g., database, cache, external service).")
    health: StrictBool = Field(description="Health status of the component. True indicates the component is functioning properly, false indicates a problem.")
    __properties: ClassVar[List[str]] = ["name", "health"]
